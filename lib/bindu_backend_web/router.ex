defmodule BinduBackendWeb.Router do
  ...
  # scope "/api", BinduBackendWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:bindu_backend, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BinduBackendWeb.Telemetry
  ...
  scope "/", BinduBackendWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{BinduBackendWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", BinduBackendWeb do
    ...
    live_session :current_user,
      on_mount: [{BinduBackendWeb.UserAuth, :mount_current_scope}] do
