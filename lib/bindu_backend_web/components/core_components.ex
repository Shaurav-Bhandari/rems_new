defmodule BinduBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BinduBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BinduBackendWeb.Gettext, "errors", msg, opts)
    end
  end
