defmodule BinduBackend.Menus.MenuItem do
  ...
  schema "menu_items" do
    ...
    belongs_to :menu_category, BinduBackend.Menus.Menu
  ...
  def changeset(menu_item, attrs) do
    menu_item
    |> cast(attrs, [:name, :description, :base_price, :is_available, :item_image_url, :estimated_prep_time, :allergen_info, :dietary_flags, :category_id])
